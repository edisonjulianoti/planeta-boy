<x-ui.section padding="sm" class="bg-zinc-950">
    <x-ui.container size="lg">
        ...
        {{-- Header --}}
        <div class="max-w-[800px] mx-auto text-center mb-16 flex flex-col items-center gap-4">
            <div class="inline-flex items-center gap-2 bg-zinc-900 rounded-[24px] px-4 py-1.5">
            ...
            <p class="text-zinc-400 text-base leading-relaxed max-w-[800px] mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[1200px] mx-auto">
            ...
            {{-- Perfis Reais --}}
            <div class="bg-zinc-900 rounded-2xl p-8 flex flex-col gap-4">
