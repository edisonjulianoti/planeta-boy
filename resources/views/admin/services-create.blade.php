...
<h2 class="text-white font-black uppercase tracking-wider text-2xl mb-6">Novo Serviço</h2>
...
<form action="{{ route('admin.services.store') }}" method="POST" class="max-w-2xl">
    ...
    <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 space-y-6">
        <x-forms.input name="name" label="Nome do serviço" placeholder="Ex: Massagem Erótica" required />
