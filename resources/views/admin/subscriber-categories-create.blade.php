...
@section('title', 'Nova Categoria de Assinante')
...
<h2 class="text-white font-black uppercase tracking-wider text-2xl mb-6">Nova Categoria de Assinante</h2>

<form action="{{ route('admin.subscriber-categories.store') }}" method="POST" class="max-w-2xl">
    @csrf
    ...
    <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 space-y-6">
        <x-forms.input name="name" label="Nome da categoria" placeholder="Ex: Básico" required />
